...
{
	  if (i) ssd1306_WriteCommand (ssd1306_INVERT_DISPLAY);

	  else ssd1306_WriteCommand (ssd1306_NORMAL_DISPLAY);
}
...
void ssd1306_SelectPage(uint8_t page_num)
{
	...
	ssd1306_WriteCommand(Result);
	ssd1306_WriteCommand(ssd1306_SET_LOWER_COLUMN);
	ssd1306_WriteCommand(ssd1306_SET_HIGHER_COLUMN);
}
